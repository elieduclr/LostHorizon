...
public class EnchantedForestLeaveDecorator extends LeaveVineDecorator {
	public static MapCodec<EnchantedForestLeaveDecorator> CODEC = MapCodec.unit(EnchantedForestLeaveDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("losthorizon:enchanted_forest_tree_leave_decorator"), () -> DECORATOR_TYPE);
	}

	public EnchantedForestLeaveDecorator() {
		super(0.25f);
	}
