package net.mcreator.losthorizon;
...
public class LosthorizonMod {
	public static final Logger LOGGER = LogManager.getLogger(LosthorizonMod.class);
	public static final String MODID = "losthorizon";

	public LosthorizonMod(IEventBus modEventBus) {
