...
public class EmeraldGoldRingItem extends Item {
	...
	public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("item.losthorizon.emerald_gold_ring.description_0"));
		list.add(Component.translatable("item.losthorizon.emerald_gold_ring.description_1"));
		list.add(Component.translatable("item.losthorizon.emerald_gold_ring.description_2"));
		list.add(Component.translatable("item.losthorizon.emerald_gold_ring.description_3"));
	}
