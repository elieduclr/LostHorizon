...
public class BackPackGuiScreen extends AbstractContainerScreen<BackPackGuiMenu> {
	...
	private static final ResourceLocation texture = ResourceLocation.parse("losthorizon:textures/screens/back_pack_gui.png");
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.losthorizon.back_pack_gui.label_backpack"), 7, 4, -16777216, false);
	}
